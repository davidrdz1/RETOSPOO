...
int main(){
   ...
   int vofP, p, l, v;
    ...
    //Primero se separan los negativos de los positivos//
    ...
    //si hay elementos en el array de positivos vofP=1//
    if(P.size()>0){
        vofP=1;
    }else{
        vofP=0;
    ...
    //sí hay elementos en P y si el primer elemento en P es 1//
    if(vofP==1){
        if(P[0]==1){
        ...
        }else{ //solamente hay valores positivos//
            p=1;
            cout<<p;
        }
